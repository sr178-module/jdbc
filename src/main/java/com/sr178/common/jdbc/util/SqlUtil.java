package com.sr178.common.jdbc.util;
...
import com.sr178.common.jdbc.BeansToSQL;
...
public class SqlUtil {
	 ...
	 * @return
	 */
	public static <T> BeansToSQL crateBeanSql(String tableName,List<T> objs) {

		BeansToSQL beansSql = new BeansToSQL();
	 ...
	 * @return
	 */
	public static BeanToSQL createBeanSql(String tableName,Object obj) {

		BeanToSQL beanSql = new BeanToSQL();
	 ...
	 * @return
	 */
	public static BeanToSQL createBeanSql(Object obj) {
	 ...
	 * @return
	 */
	public static <T> BeansToSQL crateBeanSql(List<T> objs) {
	...
	public static String joinStr(List<String> lists){
